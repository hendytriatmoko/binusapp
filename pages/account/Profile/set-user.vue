    ...
    <v-card class="pa-3">
        ...
        >
            <template v-slot:[`item.action`]="{ item }">
              <div class="ma-1">
                <v-btn @click="dialogHapus = true,pickUser = item" color="red lighten-1" small>
                    <v-icon class="mr-1" small>mdi-delete</v-icon> Delete
                </v-btn>
                <v-btn @click="dialogEdit = true,pickUser = item" color="#FCC35B" small>
    ...
    <v-dialog v-model="dialogHapus" max-width="300px">
      <v-card>
        <div class="pa-3">
          ...
          <v-card-actions>
            <v-spacer/>
            <v-btn color="blue" outlined @click="pickUser = [],dialogHapus=false">Tidak</v-btn>
            <v-btn color="red" class="white--text" @click="deleteUser()">Ya</v-btn>
          </v-card-actions>
        </div>
      </v-card>
    </v-dialog>
